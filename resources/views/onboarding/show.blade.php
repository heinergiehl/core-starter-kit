        ...
        <div class="glass-panel rounded-[32px] p-8">
            ...
            @elseif($step === 2)
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-2xl font-display font-bold text-ink">{{ __('Name Your Workspace') }}</h2>
                    <p class="text-ink/60 mt-2">{{ __('This is where you and your team will collaborate.') }}</p>
                </div>
                ...
                <form method="POST" action="{{ route('onboarding.update') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="team_name" name="team_name" type="text" class="mt-1 block w-full" :value="old('team_name', $user->currentTeam?->name)" required autofocus placeholder="{{ __('My Company') }}" />
