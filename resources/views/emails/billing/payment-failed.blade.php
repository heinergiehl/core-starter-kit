...
@section('content')
    <h1>Action Required: Payment Failed ⚠️</h1>
    
    <p>Hi {{ $user->name ?? 'there' }},</p>
    
    <p>We weren't able to process your payment for <strong>{{ $planName ?? 'your subscription' }}</strong>.</p>
    ...
    <div class="text-center">
        <a href="{{ config('app.url') }}/billing" class="btn" style="background-color: #ef4444;">
    ...
    <p class="muted mt-4">
        If you need help, our support team is here for you. We'll retry the payment automatically in a few days.
    </p>
@endsection
