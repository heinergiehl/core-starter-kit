...
return [
    ...
    */
    ...
    'github' => [
        ...
        'lookup_cache_seconds' => (int) env('GITHUB_REPO_LOOKUP_CACHE_SECONDS', 600),
        'lookup_rate_limit_per_minute' => (int) env('GITHUB_REPO_LOOKUP_RATE_LIMIT_PER_MINUTE', 15),
        'sync_rate_limit_per_minute' => (int) env('GITHUB_REPO_SYNC_RATE_LIMIT_PER_MINUTE', 5),
